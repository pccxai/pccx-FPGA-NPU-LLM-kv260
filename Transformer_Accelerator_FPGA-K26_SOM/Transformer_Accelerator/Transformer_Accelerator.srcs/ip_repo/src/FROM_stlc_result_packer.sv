            ...
            case (state)
                ...
                SEND_DATA: begin
                    if (packed_ready) begin
                        packed_data <= {capture_reg[send_idx+7], capture_reg[send_idx+6], 
                                        capture_reg[send_idx+5], capture_reg[send_idx+4],
                                        capture_reg[send_idx+3], capture_reg[send_idx+2],
                                        capture_reg[send_idx+1], capture_reg[send_idx+0]};
                        packed_valid <= 1'b1;
